...
const POSICOES_RECOMENDADAS_RANKING = [
...
function criarFiltrosPosicao() {
  ...
  POSICOES_RECOMENDADAS_RANKING.forEach(
    (posicao) => {
...
function alterarPosicaoAtiva(
  ...
  const posicaoExiste =
    POSICOES_RECOMENDADAS_RANKING.some(
      (posicao) =>
        posicao.id ===
        codigoPosicao
    );
...
function obterConfiguracaoPosicao(
  ...
  return (
    POSICOES_RECOMENDADAS_RANKING.find(
      (posicao) =>
        posicao.id ===
        codigoPosicao
    ) ||
...
function jogadorEhViavelParaRanking(
  ...
  if (
    viabilidade.bloqueado === true ||
    viabilidade.disponivel === false ||
    viabilidade.elegivel === false ||
    viabilidade.viavel === false
  ) {
...
function obterNotaAdequacaoRanking(
  ...
  if (
    viabilidade.notaAdequacao === null ||
    viabilidade.notaAdequacao === undefined
  ) {
...
function gerarExplicacaoRanking(
  ...
  if (
    resumo.notaAdequacao !== null &&
    resumo.notaAdequacao !== undefined
  ) {
...
function compararJogadoresDoRanking(
  ...
  return {
    ...
    jogadorA: {
      ...
      projecaoOriginal:
        resumoA.projecaoEstatistica,

      projecao:
        resumoA.projecaoContextualizada,

      impactoContextual:
        resumoA.impactoContextual,

      titularidade:
        resumoA.titularidade,

      riscoEscalacao:
        resumoA.riscoEscalacao,

      adequacao:
        resumoA.notaAdequacao,

      classificacaoAdequacao:
        resumoA.classificacaoAdequacao,

      coberturaAdequacao:
        resumoA.coberturaAdequacao,

      viabilidade:
        resumoA.notaViabilidade,
    ...
    jogadorB: {
      ...
      projecaoOriginal:
        resumoB.projecaoEstatistica,

      projecao:
        resumoB.projecaoContextualizada,

      impactoContextual:
        resumoB.impactoContextual,

      titularidade:
        resumoB.titularidade,

      riscoEscalacao:
        resumoB.riscoEscalacao,

      adequacao:
        resumoB.notaAdequacao,

      classificacaoAdequacao:
        resumoB.classificacaoAdequacao,

      coberturaAdequacao:
        resumoB.coberturaAdequacao,

      viabilidade:
        resumoB.notaViabilidade,
